    ...
    return (
        <div id="popup" style={{ display: display }}>
            <div className="popup-card">
                <div className="popup-content col-lg-8 col-md-8 col-sm-12 p-3 my-5">
                    ...
                    <div className="download-btns">
                            <div id='ctc' className="d-flex text-left col-sm-12 ctc" >
                                <div className="col-lg-10 col-md-10 col-sm-12 py-3 ">
                ...
                <div className="popup-img  col-lg-4 col-md-4">
